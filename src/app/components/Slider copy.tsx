...
//                 return {
//                     ...image,
//                     width: isClicked ? 1000 : 337,
//                     height: isClicked ? 400 : 400,
//                     isClicked,
//                     isContentVisible: isClicked // Display content only when clicked
//                 };
//             } else if (image.id === 1) {
//                 return {
//                     ...image,
//                     width: prevImages.find(img => img.isClicked)?.width || image.width,
//                     height: prevImages.find(img => img.isClicked)?.height || image.height,
//                     isContentVisible: prevImages.find(img => img.isClicked)?.isClicked || image.isContentVisible
//                 };
//             } else {
//                 return image;
//             }
