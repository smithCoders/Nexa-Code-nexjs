  ...
  return (
    <section className=" processes-section  h-[330px]  mt-10 flex items-center justify-center" >
        <div className="flex  flex-col  items-center justify-center">
          ...
          <Image src={logo} alt="Logo" width={80.235} height={150} />
        </div>
        {/* content */}
        <div className="flex  flex-col gap-2  items-center justify-center text-[#FFF] font-normal font-['Noto Sans KR'] text-center text-[15px]">
            <p>(주)넥사코드</p>
